namespace Nop.Core.Domain.Messages
{
    ...
    public static partial class MessageTemplateSystemNames
    {
        ...
        /// <summary>
        /// Represents system name of password create message
        /// </summary>
        public const string CustomerPasswordCreateMessage = "Customer.PasswordCreate";

        /// <summary>
        /// Represents system name of password create message
        /// </summary>
        public const string ShipmentSentFreightQuoteNotification = "ShipmentSent.FreightQuoteNotification";

        /// <summary>
        /// Represents system name of password create message
        /// </summary>
        public const string ShipmentSentFreightQuoteCustomerNotification = "ShipmentSent.FreightQuoteCustomerNotification";
        /// <summary>
        /// Represents system name of shopping cart awaiting checkout message
        /// </summary>
        public const string ShoppingCartAwaitingCheckout = "ShoppingCart.AwaitingCheckout";
        ...
        /// <summary>
        /// Represents system name of notification customer about update order
        /// </summary>
        public const string OrderUpdateCustomerNotification = "OrderUpdate.CustomerNotification";
        ...
        /// <summary>
        /// was paid order completed
        /// </summary>
        public const string OrderCompletedWasPaid = "OrderCompleted.WasPaidNotification";

        /// <summary>
        /// Represents system name of notification customer about paid order
        /// </summary>
        public const string InvoiceCompletedWasPaidNotification = "InvoiceCompleted.WasPaidNotification";
