...
namespace Nop.Core.Domain.Customers
{
    ...
    public static partial class NopCustomerDefaults
    {
        ...
        public static string AccounntRoleName => "AccountCustomer";
        ...
        /// Gets a name of generic attribute to store the value of 'Phone'
        /// </summary>
        public static string MobilePhoneAttribute => "MobilePhone";

        /// <summary>
        /// Gets a name of generic attribute to store the value of 'Phone'
        /// </summary>
        public static string OfficePhoneAttribute => "OfficePhone";
        ...
        /// <summary>
        /// Gets a name of generic attribute to store the value of 'PasswordCreateToken'
        /// </summary>
        public static string PasswordCreateTokenAttribute => "PasswordCreateToken";
        ...
        public static string SelectedShippingOptionAttributeIsCommercial => "SelectedShippingOptionIsCommercial";
        ...
        public static string OrderToBepaid => "OrderToBepaid";

        public static string PoNumberAttribute => "PONumber";

        public static string Saveaddresstomyaccount => "Saveaddresstomyaccount";
        public static string IsDefaultBilling => "IsDefaultBilling";

        public static string SaveShippingaddress => "SaveShippingaddress";

        public static string IsDefaultShipping => "IsDefaultShipping";

        public static string ShipToSameAddress => "ShipToSameAddress";
