...
namespace Nop.Core.Domain.Customers
{
    ...
    public partial class Customer : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the parent identifier asociated about customer child
        /// </summary>
        public int Parent { get; set; }

        /// <summary>
        /// Gets or sets Netsuit Id
        /// </summary>
        public int NetsuitId { get; set; }
        ...
        {
            get => _companies ?? (_companies = CompanyCustomerMappings.Select(mapping => mapping.Company).ToList());
        }
