...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported
    {
        ...
        private ICollection<PriceByQtyProduct> _priceByQtyProduct;
        ...
        public string IdInventoryItem { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this product IncrementQuantity in shopping cart
        /// </summary>
        ...
        public string SpecificationClass { get; set; }
        public string SpecificationClassId { get; set; }
        /// <summary>
        ...
        public bool ItemCollectionStatus { get; set; }
        
        public string Custitem_branded_variants { get; set; }
        ...
        /// <summary>
        /// Gets or sets the collection of "PriceByQtyProduct" records.
        /// </summary>
        public virtual ICollection<PriceByQtyProduct> PriceByQtyProduct
        {
            get => _priceByQtyProduct ?? (_priceByQtyProduct = new List<PriceByQtyProduct>());
            protected set => _priceByQtyProduct = value;
        }
    }
}