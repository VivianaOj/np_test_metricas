...
namespace Nop.Data.Mapping.Customers
{
    ...
    public partial class CustomerMap : NopEntityTypeConfiguration<Customer>
    {
        ...
        public override void Configure(EntityTypeBuilder<Customer> builder)
        {
            ...
            builder.Property(customer => customer.Parent).HasColumnName("Parent");
            builder.Property(customer => customer.NetsuitId).HasColumnName("NetsuitId");
            ...
            builder.HasOne(customer => customer.PriceLevel)
         .WithMany()
         .HasForeignKey(customer => customer.PriceLevelId);
