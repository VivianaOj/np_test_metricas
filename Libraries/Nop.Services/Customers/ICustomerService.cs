...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        IPagedList<Customer> GetAllReportCustomers(DateTime? createdFromUtc = null, DateTime? createdToUtc = null,
        ...
        /// <returns></returns>
        Customer GetCustomerByGuidEmail(Guid customerGuid, string email);
        ...
        /// <summary>
        /// Get customer by netsuit id, Verify this user exist
        /// </summary>
        /// <param name="NetsuitId"></param>
        /// <returns></returns>
        Customer GetCustomerByNetsuitId(int NetsuitId, string email = null);

        List<Customer> GetChildsByNetsuitId(int NetsuitId);
        ...
        /// <returns></returns>
        int SearchCustomerRole(int CustomerId);
        ...
        /// <returns>
        /// The  result contains the result
        /// </returns>
        ...
        List<CustomerCustomerRoleMapping> GetCustomerCustomerOrleById(int CustomerId);
