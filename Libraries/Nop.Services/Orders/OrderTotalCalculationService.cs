...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderTotalCalculationService : IOrderTotalCalculationService
    {
        ...
        public virtual void GetShoppingCartSubTotal(IList<ShoppingCartItem> cart, bool includingTax,
            ...
            out decimal subTotalWithoutDiscount, out decimal subTotalWithDiscount, decimal shipping)
        {
            //Start N&N Changes
            GetShoppingCartSubTotal(cart, includingTax,
                out discountAmount, out appliedDiscounts,
                out subTotalWithoutDiscount, out subTotalWithDiscount, out _, out _,  shipping);
            //End N&N Changes
        }
            ...
            out decimal subTotalWithoutDiscount, out decimal subTotalWithDiscount)
        {
            ...
            GetShoppingCartSubTotal(cart, includingTax,
                out discountAmount, out appliedDiscounts,
                out subTotalWithoutDiscount, out subTotalWithDiscount, out _, out _);
            //End N&N Changes
        }
        ...
        public virtual void GetShoppingCartSubTotal(IList<ShoppingCartItem> cart,
            ...
            out decimal discountAmount, out List<DiscountForCaching> appliedDiscounts,
            out decimal subTotalWithoutDiscount, out decimal subTotalWithDiscount,
            out SortedDictionary<decimal, decimal> taxRates, out decimal amountCollectTax, decimal shipping = 0, bool checkoutProcess=false)
        {
            //Start N&N Changes
            amountCollectTax = decimal.Zero;
            //End N&N Changes
            ...
            foreach (var shoppingCartItem in cart)
            {
                ...
                //Start N&N Changes
                var sciExclTax = _taxService.GetProductPrice(shoppingCartItem.Product, sciSubTotal, false, customer, out var taxRate, out decimal amountCollect, false, decimal.Zero);
                var sciInclTax = _taxService.GetProductPrice(shoppingCartItem.Product, sciSubTotal, true, customer, out taxRate, out decimal amountCollectInc, false, decimal.Zero);
                amountCollectTax = amountCollectInc;
                totalTax += amountCollect;
                //End N&N Changes
            ...
            var taxFinalOrder = _taxService.GetProductPrice(null, subTotalExclTaxWithoutDiscount, false, customer, out var taxRate2, out decimal amountCollect2, true, shipping);
            amountCollectTax = amountCollect2;
        ...
        public virtual bool IsFreeShipping(IList<ShoppingCartItem> cart, decimal? subTotal = null)
        {
            ...
            {
                GetShoppingCartSubTotal(cart, _shippingSettings.FreeShippingOverXIncludingTax, out _, out _, out _, out var subTotalWithDiscount, decimal.Zero);
        ...
        /// <returns>Tax total</returns>
        public virtual decimal GetTaxTotal(IList<ShoppingCartItem> cart, IList<IShippingRateComputationMethod> shippingRateComputationMethods = null, bool usePaymentMethodAdditionalFee = true, decimal shipping=0, bool checkoutProcess=false)
        {
            if (cart == null)
                throw new ArgumentNullException(nameof(cart));

            return GetTaxTotal(cart, shippingRateComputationMethods, out _, usePaymentMethodAdditionalFee, shipping, checkoutProcess);
        }
        ...
        public virtual decimal GetTaxTotal(IList<ShoppingCartItem> cart, IList<IShippingRateComputationMethod> shippingRateComputationMethods,
            out SortedDictionary<decimal, decimal> taxRates, bool usePaymentMethodAdditionalFee = true, decimal shipping = 0,  bool checkoutProcess=false)
        {
            if (cart == null)
                throw new ArgumentNullException(nameof(cart));
            ...
            //Start N&N Changes
            GetShoppingCartSubTotal(cart, false, out _, out _, out _, out _, out var orderSubTotalTaxRates, out decimal amountCollect, shipping, checkoutProcess);
            //End N&N Changes
            ...
            //summarize taxes
            //Start N&N Changes
            var taxTotal = amountCollect;//subTotalTaxTotal + shippingTax + paymentMethodAdditionalFeeTax;
            //End N&N Changes
            //ensure that tax is equal or greater than zero
            if (taxTotal < decimal.Zero)
                taxTotal = decimal.Zero;
            ...
            bool? useRewardPoints = null, bool usePaymentMethodAdditionalFee = true)
        {
            ...
            GetShoppingCartSubTotal(cart, false, out _, out _, out _, out var subTotalWithDiscountBase, decimal.Zero);
            ...
            //tax
            var shoppingCartTax = decimal.Zero;
            if (shoppingCartShipping==null)
                 shoppingCartTax = GetTaxTotal(cart, shippingRateComputationMethods, usePaymentMethodAdditionalFee);
            else
                 shoppingCartTax = GetTaxTotal(cart, shippingRateComputationMethods, usePaymentMethodAdditionalFee, (decimal)shoppingCartShipping, true);
            //order total
