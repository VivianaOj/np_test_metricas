...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderReportService
    {
        ...
        int[] GetAlsoPurchasedProductsIds(int storeId, int productId, int recordsToReturn = 5, int customerId = 0 , bool visibleIndividuallyOnly = true, bool showHidden = false);
        ...
        IPagedList<SearchTermReportLine> SearchWordsReport(
           DateTime? createdFromUtc = null, DateTime? createdToUtc = null,
           int pageIndex = 0, int pageSize = int.MaxValue);
    }
}
