...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderProcessingService
    {
        ...
        PlaceOrderResult PlaceOrderValidate(ProcessPaymentRequest processPaymentRequest);
        
        PlaceOrderResult RetryPlaceOrder(ProcessPaymentRequest processPaymentRequest);
