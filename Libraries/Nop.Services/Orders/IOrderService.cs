...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderService
    {
        ...
        IPagedList<Order> OverriddenSearchOrders(int storeId = 0,
            int vendorId = 0, int customerId = 0,
            int productId = 0, int affiliateId = 0, int warehouseId = 0,
            int billingCountryId = 0, string paymentMethodSystemName = null,
            DateTime? createdFromUtc = null, DateTime? createdToUtc = null,
            List<int> osIds = null, List<int> psIds = null, List<int> ssIds = null, List<int> CompanyIds = null, List<int> UserRoleIds = null, string SourceName=null,
        ...
        IPagedList<Order> OverriddenSearchOrdersParent(int storeId = 0,
           int vendorId = 0, int customerId = 0,
           int productId = 0, int affiliateId = 0, int warehouseId = 0,
           int billingCountryId = 0, string paymentMethodSystemName = null,
           DateTime? createdFromUtc = null, DateTime? createdToUtc = null,
        ...
        Order GetOrderByNetsuiteId(string tranId);

        List<Order> GetOrderByCustomer(int orderIds);

        List<Order> GetOrderByEmail(string email, string orderId);

        List<Order> GetOrderFromNetsuitePendingFulfillment(int id);
        List<Order> GetOrderByCompanyByPendingBilling(int id);

        List<Order> GetOrderByCompanyByBilled(int id);
        ...
        /// <param name="orderItemId">Order item identifier</param>
        /// <returns>Order item</returns>
        ICollection<OrderItem> GetOrderItemByOrderId(int OrderId);
        ...
        IList<Invoice> GetOpenInvoice(int companyId);
        List<Invoice> GetInvoiceByOrderId(int orderId);
        #endregion
