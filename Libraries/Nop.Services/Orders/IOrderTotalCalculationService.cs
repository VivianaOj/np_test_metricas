...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderTotalCalculationService
    {
        ...
        void GetShoppingCartSubTotal(IList<ShoppingCartItem> cart, 
            ...
            out decimal subTotalWithoutDiscount, out decimal subTotalWithDiscount, decimal shipping = 0);
        ...
        decimal GetTaxTotal(IList<ShoppingCartItem> cart, IList<IShippingRateComputationMethod> shippingRateComputationMethods, bool usePaymentMethodAdditionalFee = true, decimal shipping = 0, bool checkoutProcess=false);
        ...
        decimal GetTaxTotal(IList<ShoppingCartItem> cart, IList<IShippingRateComputationMethod> shippingRateComputationMethods, out SortedDictionary<decimal, decimal> taxRates, 
            bool usePaymentMethodAdditionalFee = true, decimal shipping=0, bool checkoutProcess=false);
