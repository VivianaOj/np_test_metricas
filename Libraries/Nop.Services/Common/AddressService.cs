...
namespace Nop.Services.Common
{
    ...
    public partial class AddressService : IAddressService
    {
        ...
        public List<Address> GetAddressByNetsuiteId(int netsuiteId)
        {
            ...
            var query = from a in _addressRepository.Table
                        where a.NetsuitId == netsuiteId
                        select a;

            return query.ToList();
        }

        public List<Address> GetAddressByNetsuiteId(int netsuiteId, string email)
        {
            ...
            var query = from a in _addressRepository.Table
                        where a.NetsuitId == netsuiteId && a.Email==email
                        select a;
