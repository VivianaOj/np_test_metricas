...
namespace Nop.Services.Shipping
{
    ...
    public partial class ShipmentService : IShipmentService
    {
        ...
        /// </summary>
        /// <param name="orderId">Shipment identifier</param>
        /// <returns>Shipment</returns>
        public virtual IList<Shipment> GetShipmentByOrderId(int orderId)
        {
            if (orderId == 0)
                return null;

            return _shipmentRepository.Table.Where(x => x.OrderId == orderId).ToList();
        }
