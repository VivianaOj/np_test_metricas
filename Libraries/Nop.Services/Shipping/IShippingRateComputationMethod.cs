...
namespace Nop.Services.Shipping
{
    ...
    public partial interface IShippingRateComputationMethod : IPlugin
    {
        ...
        List<Package> GetShippingPackingOptions(GetShippingOptionRequest getShippingOptionRequest);
        ...
        GetShippingOptionRequest GetBoxesPackingData(GetShippingOptionRequest shippingOptionRequest);
    }
