...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord PaymentInvoice = new PermissionRecord { Name = "Admin.Reports.PaymentInvoice", SystemName = "PaymentInvoice", Category = "Orders" };

        public static readonly PermissionRecord NetSuiteConnector = new PermissionRecord { Name = "Admin area. Manage NetSuiteConnector", SystemName = "NetSuiteConnector", Category = "Plugin Configuration" };
        public static readonly PermissionRecord NNBoxGenerator = new PermissionRecord { Name = "Admin area.Manage NNBoxGenerator", SystemName = "NNBoxGenerator", Category = "Plugin Configuration" };
