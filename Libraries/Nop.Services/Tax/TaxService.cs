...
namespace Nop.Services.Tax
{
    ...
    public partial class TaxService : ITaxService
    {
        ...
        //Start N&N Changes parameter amountCollect
        protected virtual void GetTaxRate(Product product, int taxCategoryId,
        Customer customer, decimal price, out decimal taxRate, out bool isTaxable, bool isShippint, out decimal  amountCollect, bool checkoutProcess, decimal shippingValue)
        {
            taxRate = decimal.Zero;
            isTaxable = true;
            //Start N&N Changes
            amountCollect = decimal.Zero;
            //End N&N Changes
            //active tax provider
            ...
            calculateTaxRequest.CheckoutProcess = checkoutProcess;
            calculateTaxRequest.ShippingValue = shippingValue;
            //get tax rate
            var calculateTaxResult = activeTaxProvider.GetTaxRate(calculateTaxRequest);
            //Start N&N Changes
            amountCollect = calculateTaxResult.amount_to_collect;
            
            if (isShippint)
            {
               // if(calculateTaxResult.freight_taxable==false)
        ...
        public virtual decimal GetProductPrice(Product product, decimal price,
            out decimal taxRate, bool checkoutProcess, decimal shippingValue)
        {
            var customer = _workContext.CurrentCustomer;
            return GetProductPrice(product, price, customer, out taxRate,checkoutProcess,shippingValue);
        }
        ...
        /// <returns>Price</returns>
        public virtual decimal GetProductPrice(Product product, decimal price,
            Customer customer, out decimal taxRate, bool checkoutProcess, decimal shippingValue)
        {
            var includingTax = _workContext.TaxDisplayType == TaxDisplayType.IncludingTax;
            //Start N&N Changes
            return GetProductPrice(product, price, includingTax, customer, out taxRate, out var _, checkoutProcess,  shippingValue);
            //End N&N Changes
        }
        ...
        //Start N&N Changes
        public virtual decimal GetProductPrice(Product product, decimal price,
        bool includingTax, Customer customer, out decimal taxRate, out decimal amountCollect, bool checkoutProcess, decimal shippingValue)
        {
            var priceIncludesTax = _taxSettings.PricesIncludeTax;
            var taxCategoryId = 0;
            return GetProductPrice(product, taxCategoryId, price, includingTax,
                customer, priceIncludesTax, out taxRate, false, out amountCollect,checkoutProcess,shippingValue);
        }
        //End N&N Changes
        /// <summary>
        /// Gets price
        ...
        public virtual decimal GetProductPrice(Product product, int taxCategoryId,
            ...
            bool priceIncludesTax, out decimal taxRate, bool isShippint, out decimal amountCollect, bool checkoutProcess, decimal shippingValue)
        {
            ...
            //Start N&N Changes
            GetTaxRate(product, taxCategoryId, customer, price, out taxRate, out var isTaxable, isShippint, out amountCollect, checkoutProcess, shippingValue);
            //End N&N Changes
            if (priceIncludesTax)
            {
        ...
        public virtual decimal GetShippingPrice(decimal price, bool includingTax, Customer customer, out decimal taxRate)
        {
            ...
            return GetProductPrice(null, taxClassId, price, includingTax, customer,
                priceIncludesTax, out taxRate, true, out _, false, decimal.Zero);
            //End N&N Changes
        }
        ...
        public virtual decimal GetPaymentMethodAdditionalFee(decimal price, bool includingTax, Customer customer, out decimal taxRate)
        {
            ...
            //Start N&N Changes
            return GetProductPrice(null, taxClassId, price, includingTax, customer,
            priceIncludesTax, out taxRate, false, out _,false, decimal.Zero);
            //End N&N Changes
        }
