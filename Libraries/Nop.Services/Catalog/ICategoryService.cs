...
namespace Nop.Services.Catalog
{
    ...
    public partial interface ICategoryService
    {
        ...
        /// Gets a category
        /// </summary>
        /// <param name="netsuiteId">Category netsuiteId identifier</param>
        /// <returns>Category</returns>
        Category GetCategoryByNetsuiteId(int netsuiteId);

        /// <summary>
        /// Gets a category
        /// </summary>
        /// <param name="netsuiteName">Category netsuiteName identifier</param>
        /// <returns>Category</returns>
        Category GetProductsByCategorynameNetsuite(string netsuiteName, int NetSuiteId, int CategoryId=0);

        Category GetProductsByCategorynameNetsuiteValid(string netsuiteName, int NetSuiteId);
