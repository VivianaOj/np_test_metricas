...
{
    public partial interface IFreigthQuoteService
    {
        void InsertFreightQuote(FreightQuote FreigthQuote);
        IList<FreightQuote> GetFreigthQuote();

        IPagedList<FreightQuote> SearchFreigthQuote(int storeId = 0,
