...
namespace Nop.Services.Messages
{
    ...
    public partial interface IMessageTokenProvider
    {
        ...
        void AddOrderTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0, IList<ShoppingCartItem> cart = null, bool totals = true, bool showShipping = false, string ResidentialAddress=null, string TractorAccessible = null, string trailerEnterExit = null,
        ...
        /// <param name="tokens">List of already added tokens</param>
        /// <param name="customer">Customer</param>
        void AddAccountCustomerTokens(IList<Token> tokens, Customer customer);
