...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// <summary>
        /// Sends password create message to a customer
        /// </summary>
        /// <param name="customer">Customer instance</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendCustomerCreatePasswordMessage(Customer customer, int languageId);
        ...
        /// <returns></returns>
        IList<int> SendCustomerShoppingCartAwaitingMessage(Customer customer, int languageId);
        ...
        /// <param name="languageId"></param>
        /// <returns></returns>
        IList<int> SendUpdateOrderNotification(Order order, int languageId);
        ...
        /// <returns>Queued email identifier</returns>
        IList<int> SendContactUsMessage(int languageId, string senderEmail, string senderName, string subject, string body, string phoneNumber, string company);
        ...
        /// <summary>
        /// Sends Freigh Quote message to a Nop Admin
        /// </summary>
        IList<int> SendEmailFreightQuote(Order order, IList<ShoppingCartItem> cart, int languageId, string ResidentialAddress, string TractorAccessible, string trailerEnterExit,
            string StandardDock, string AppointmentDelivery, string StandardReceiving, string email, string phoneNumber);

        /// <summary>
        /// Order Completed was paid
        /// </summary>
        IList<int> SendEmailOrderCompletedWasPaid(Order order, int languageId,
            string attachmentFilePath = null, string attachmentFileName = null);
        #endregion

        #region Invoice
        IList<int> SendInvoicePaidCustomerNotification(List<Services.Payments.InvoicesToPay> order, decimal TotalPayInvoice, Address address, int languageId,
