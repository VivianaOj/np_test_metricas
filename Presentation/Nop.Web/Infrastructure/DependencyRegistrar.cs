...
namespace Nop.Web.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<CompanyModelFactory>().As<ICompanyModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<ItemCollectionServices>().As<IItemCollectionServices>().InstancePerLifetimeScope();
            
            builder.RegisterType<InvoiceService>().As<IInvoiceService>().InstancePerLifetimeScope();
            builder.RegisterType<FreigthQuoteService>().As<IFreigthQuoteService>().InstancePerLifetimeScope();
            
            builder.RegisterType<CustomerAccountCreditBalanceService>().As<ICustomerCreditBalanceService>().InstancePerLifetimeScope();
            builder.RegisterType<InvoicePaymentService>().As<IInvoicePaymentService>().InstancePerLifetimeScope();
            //builder.RegisterType<CustomerAuthorizeNetService>().As<ICustomerAuthorizeNetService>().InstancePerLifetimeScope();
            builder.RegisterType<CustomerAccountCreditApplyService>().As<ICustomerAccountCreditApplyService>().InstancePerLifetimeScope();

            builder.RegisterType<PriceLevelService>().As<IPriceLevelService>().InstancePerLifetimeScope();
            builder.RegisterType<ProductService>().As<IProductService>().InstancePerLifetimeScope();
            builder.RegisterType<WarehouseLocationNNService>().As<IWarehouseLocationNNService>().InstancePerLifetimeScope();
