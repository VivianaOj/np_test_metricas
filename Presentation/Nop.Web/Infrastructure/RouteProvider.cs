...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            //validate register
            routeBuilder.MapLocalizedRoute("ValidateRegister", "validateregister/",
                new { controller = "Customer", action = "ValidateRegister" });

            //validate register
            routeBuilder.MapLocalizedRoute("PasswordCreateConfirm", "passwordcreateconfirm/",
                new { controller = "Customer", action = "PasswordCreateConfirm" });
            ...
            //shopping cart
            routeBuilder.MapLocalizedRoute("ClearShoppingCart", "ClearShoppingCart/",
                new { controller = "ShoppingCart", action = "ClearShoppingCart" });

            //shopping cart
            routeBuilder.MapLocalizedRoute("UpdateCartItem", "UpdateCartItem",
                new { controller = "ShoppingCart", action = "UpdateCartItem" });
            ...
            routeBuilder.MapLocalizedRoute("CheckOrder", "order/check",
                new { controller = "Order", action = "CheckOrder" });
            ...
            //contact us
            routeBuilder.MapLocalizedRoute("SuccessMessage", "SuccessMessage",
                new { controller = "Common", action = "SuccessMessage" });
            ...
            routeBuilder.MapLocalizedRoute("ProductSearchPrice" , "filterPrice/",
             new { controller = "Catalog", action = "_SearchFiterPrice" });
            ...
            //change company (AJAX link)
            routeBuilder.MapLocalizedRoute("ChangeCompany", "changecompany/{customercompany:min(0)}",
                new { controller = "Common", action = "SetCompany" });
            ...
            //check username availability
            routeBuilder.MapLocalizedRoute("CheckUserCompanyAvailability", "customer/checkusercompanyavailability",
                new { controller = "Customer", action = "CheckUserCompanyAvailability" });
            ...
            routeBuilder.MapLocalizedRoute("RetryPayment", "retrypayment/{orderId:min(0)}",
                new { controller = "Checkout", action = "StartRetryPaymentMethod" });

            routeBuilder.MapLocalizedRoute("RetryPaymentConfirm", "checkout/RetryPaymentConfirm",
                new { controller = "Checkout", action = "RetryPaymentConfirm" });

            routeBuilder.MapLocalizedRoute("OrderListToPayConfirm", "order/OrderListToPayConfirm",
                new { controller = "order", action = "OrderListToPayConfirm" });

            routeBuilder.MapLocalizedRoute("OrderListToPayStepFinish", "order/OrderListToPayStepFinish/",
                new { controller = "order", action = "OrderListToPayStepFinish" });

            routeBuilder.MapLocalizedRoute("InvoiceListToPayConfirm", "order/InvoiceListToPayConfirm",
                new { controller = "order", action = "InvoiceListToPayConfirm" });

            routeBuilder.MapLocalizedRoute("InvoiceListToPayStepFinish", "order/InvoiceListToPayStepFinish/",
                new { controller = "order", action = "InvoiceListToPayStepFinish" });
        }
