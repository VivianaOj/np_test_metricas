...
namespace Nop.Web.Extensions
{
    public static class HtmlExtensions
    {
        ...
        public static int GetSessionInt(this IHtmlHelper html, string nameKey)
        {
            return html.ViewContext.HttpContext.Session.GetInt32("filterCurrentCategory").GetValueOrDefault();
        }
    }
}