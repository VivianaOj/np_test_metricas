...
namespace Nop.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
        ...
        public CommonController(CaptchaSettings captchaSettings,
            ...
            VendorSettings vendorSettings, ICompanyService companyService, ISettingService settingService)
        {
        ...
        //available even when navigation is not allowed
        [CheckAccessPublicStore(true)]
        public virtual IActionResult SetCompany(int customerCompany, string returnUrl = "")
        {
            var company = _workContext.CurrentCustomer.Companies.FirstOrDefault(c => c.Id == customerCompany);
            ...
            if (company != null)
            {
                ...
                //Set Company Defaul
                if (company.Id!=null)
                    _companyService.SetDefaulCompanyCustomer(company.Id, _workContext.CurrentCustomer.Id);
            }
        ...
        public virtual IActionResult ContactUsSend(ContactUsModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _workflowMessageService.SendContactUsMessage(_workContext.WorkingLanguage.Id,
                    model.Email.Trim(), string.Concat(model.FullName, " ", model.LastName), subject, body, model.PhoneNumber, model.Company);
        ...
        {
            var storeInformationSettings = _settingService.LoadSetting<StoreInformationSettings>(_storeContext.CurrentStore.Id);

            var closed = storeInformationSettings.StoreClosed;
            if(closed)
                return View();
            else
        ...
        public virtual IActionResult SuccessMessage()
        {
