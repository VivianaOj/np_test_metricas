...
namespace Nop.Web.Controllers
{
    public partial class CatalogController : BasePublicController
    {
        ...
        public virtual IActionResult Category(int categoryId, CatalogPagingFilteringModel command)
        {
            ...
            //model
            var dato = _webHelper.QueryString<string>(QUERYSTRINGPARAM);
            if (!string.IsNullOrEmpty(_webHelper.QueryString<string>(QUERYSTRINGPARAM)))
            {
                category.PriceRanges = _webHelper.QueryString<string>(QUERYSTRINGPARAM);
            }
