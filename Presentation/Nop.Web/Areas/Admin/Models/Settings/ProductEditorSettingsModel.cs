...
namespace Nop.Web.Areas.Admin.Models.Settings
{
    ...
    public partial class ProductEditorSettingsModel : BaseNopModel, ISettingsModel
    {
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.IncrementQuantity")]
        public bool IncrementQuantity { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.QuantityMessage")]
        public bool QuantityMessage { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.OutStock")]
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.branded_variants")]
