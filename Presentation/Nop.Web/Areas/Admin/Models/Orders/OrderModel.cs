...
namespace Nop.Web.Areas.Admin.Models.Orders
{
    ...
    public partial class OrderModel : BaseNopEntityModel
    {
        ...
        public OrderModel()
        {
            ...
            BoxGenerator = new List<BoxGeneratorModel>();
        }
        ...
        [NopResourceDisplayName("Admin.Orders.Fields.CustomOrderNumberNS")]
        ...
        #region Start NN New field Customer Role 
        public List<BoxGeneratorModel> BoxGenerator { get; set; }

        [NopResourceDisplayName("Admin.Orders.Fields.CustomerRole")]
        public string  CustomerRole { get; set; }

        [NopResourceDisplayName("Admin.Orders.Fields.CompanyName")]
        public string CompanyName { get; set; }

        [NopResourceDisplayName("Admin.Orders.Fields.UserRolesNames")]
        public string UserRolesNames { get; set; }

        [NopResourceDisplayName("Admin.Orders.Fields.TransactionLocation")]
        public string TransactionLocation { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.NNdeliveryRouteLocation")]
        public string NNdeliveryRouteLocation { get; set; }

        [NopResourceDisplayName("Admin.Orders.Fields.source")]
    ...
    public  class BoxGeneratorModel : BaseNopEntityModel
    {
