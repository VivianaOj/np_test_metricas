...
namespace Nop.Web.Areas.Admin.Models.Common
{
    public partial class AddressModel : BaseNopEntityModel
    {
        ...
        [NopResourceDisplayName("admin.address.fields.active")]
        public bool Active { get; set; }

        [NopResourceDisplayName("account.fields.residential")]
        public bool Residential { get; set; }

        [NopResourceDisplayName("account.fields.ApprovedNNDelivery")]

        public string ApprovedNNDelivery { get; set; }
        ...
        public bool SavedAddressRequest { get; set; }
