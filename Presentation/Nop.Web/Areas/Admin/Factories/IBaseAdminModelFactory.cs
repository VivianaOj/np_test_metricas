...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IBaseAdminModelFactory
    {
        ...
        void PrepareCompanyList(IList<SelectListItem> items, bool withSpecialDefaultItem = true, string defaultItemText = null);
        void PrepareUserRoleList(IList<SelectListItem> items, bool withSpecialDefaultItem = true, string defaultItemText = null);
        ...
        void PrepareInvoiceStatuses(IList<SelectListItem> items, bool withSpecialDefaultItem = true, string defaultItemText = null);
    }
}