...
namespace Nop.Web.Areas.Admin.Factories
{
	...
	public partial interface IReportModelFactory
	{
		...
		#region SearchWord
		SearchedWordListModel PrepareSearchedWordListModel(SearchedWordSearchModel searchModel);
		SearchedWordSearchModel PrepareSearchedWordSearchModel(SearchedWordSearchModel searchModel);
