...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IShippingModelFactory
    {
        ...
        WarehouseLocationNNSearchModel PrepareWarehouseLocationNNSearchModel(WarehouseLocationNNSearchModel searchModel);

        WarehouseLocationNNListModel PrepareNNWarehouseListModel(WarehouseLocationNNSearchModel searchModel);
    }
}