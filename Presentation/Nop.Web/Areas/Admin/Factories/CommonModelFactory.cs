...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public CommonModelFactory(AdminAreaSettings adminAreaSettings,
            ...
            ProxySettings proxySettings, IShoppingCartService shoppingCartService)
        {
        ...
        public virtual CommonStatisticsModel PrepareCommonStatisticsModel()
        {
            ...
            model.NumberOfCustomers = _customerService.GetAllReportCustomers(DateTime.Now, customerRoleIds: customerRoleIds,
            ...
            var customerAccountRoleIds = new[] { _customerService.GetCustomerRoleBySystemName(NopCustomerDefaults.AccounntRoleName).Id };
            model.AccountCustomer = _customerService.GetAllCustomers(customerRoleIds: customerAccountRoleIds,
                pageIndex: 0, pageSize: 1, getOnlyTotalCount: true).TotalCount;

            var TotalCustomersToday = _customerService.GetAllCustomers(DateTime.Now, customerRoleIds: customerAccountRoleIds,
                pageIndex: 0, pageSize: 1, getOnlyTotalCount: true).TotalCount;
            model.CountOrdersToday = TotalCustomersToday;
