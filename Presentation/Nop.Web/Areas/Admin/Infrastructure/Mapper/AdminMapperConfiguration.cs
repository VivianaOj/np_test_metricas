...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateOrdersMaps()
        {
            ...
            CreateMap<Order, CompanyOrderModel>()
                .ForMember(model => model.CreatedOn, options => options.Ignore())
                .ForMember(model => model.OrderStatus, options => options.Ignore())
                .ForMember(model => model.PaymentStatus, options => options.Ignore())
                .ForMember(model => model.ShippingStatus, options => options.Ignore())
        ...
        /// Create company maps 
        /// </summary>
        protected virtual void CreateCompanyMaps()
        {
            CreateMap<Company, CompanyModel>()
               .ForMember(entity => entity.CustomProperties, options => options.Ignore());
            ...
            CreateMap<CompanyModel, Company>()
                .ForMember(entity => entity.ShippingAddress, options => options.Ignore());
            CreateMap<CompanyModel, Company>()
                .ForMember(entity => entity.Addresses, options => options.Ignore());
            CreateMap<CompanyModel, Company>()
                .ForMember(entity => entity.Customers, options => options.Ignore());
            CreateMap<CompanyModel, Company>()
                .ForMember(entity => entity.CompanyCustomerMappings, options => options.Ignore());
        }
