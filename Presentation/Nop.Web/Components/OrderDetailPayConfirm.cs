...
{
    public class OrderDetailPayConfirmViewComponent : NopViewComponent
    {
        ...
        public OrderDetailPayConfirmViewComponent(IOrderService orderService, IGenericAttributeService genericAttributeService,
