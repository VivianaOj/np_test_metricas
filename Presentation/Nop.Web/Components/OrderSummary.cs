...
namespace Nop.Web.Components
{
    public class OrderSummaryViewComponent : NopViewComponent
    {
        ...
        public IViewComponentResult Invoke(bool? prepareAndDisplayOrderReviewData, ShoppingCartModel overriddenModel, bool? prepareAndDisplayRelatedProducts = false, bool IsFromCheckout = false)
        {
            ...
            model.IsFromCheckout = IsFromCheckout;
