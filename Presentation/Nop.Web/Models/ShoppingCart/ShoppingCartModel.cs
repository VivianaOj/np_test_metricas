...
namespace Nop.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseNopModel
    {
        public ShoppingCartModel()
        {
            ...
            ProductIds = new List<ProductOverviewModel>();
        }

        //Esta variable identifica si se visualiza desde el checkout
        public bool IsFromCheckout { get; set; } = false;

        public bool OnePageCheckoutEnabled { get; set; }
        public bool ShowSku { get; set; }
        public bool ShowProductImages { get; set; }
        public bool IsEditable { get; set; }
        public IList<ProductOverviewModel> ProductIds { get; set; }
