...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<EfRepository<PriceLevel>>().As<IRepository<PriceLevel>>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<ItemPricingService>().As<IItemPricingService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<ZidCodeService>().As<IZipCodeService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<LogImportNetsuiteService>().As<ILogImportNetsuiteService>().InstancePerLifetimeScope();

            builder.RegisterType<PendingDataToSyncService>().As<IPendingDataToSyncService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<BoxesGeneratorServices>().As<IBoxesGeneratorServices>().InstancePerLifetimeScope();
