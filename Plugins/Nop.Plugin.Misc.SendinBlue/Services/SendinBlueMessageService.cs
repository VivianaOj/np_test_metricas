...
namespace Nop.Plugin.Misc.SendinBlue.Services
{
    ...
    public class SendinBlueMessageService : WorkflowMessageService
    {
        ...
        public SendinBlueMessageService(CommonSettings commonSettings,
            ...
            ITokenizer tokenizer, IWorkContext workContext, IGenericAttributeService genericAttributeService,ISettingService settingService1,
            ...
            : base(commonSettings,
                ...
                storeContext,
                storeService,
                tokenizer, workContext, genericAttributeService, settingService1)
        {
