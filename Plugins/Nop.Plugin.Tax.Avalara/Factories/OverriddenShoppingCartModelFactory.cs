...
namespace Nop.Plugin.Tax.Avalara.Factories
{
    ...
    public class OverriddenShoppingCartModelFactory : ShoppingCartModelFactory
    {
        ...
        public OverriddenShoppingCartModelFactory(AddressSettings addressSettings,
            ...
            IOrderService orderService, IAclService aclService) : base(addressSettings,
                captchaSettings,
                catalogSettings,
                commonSettings,
                customerSettings,
        ...
        private void PrepareTaxDetails(IList<ShoppingCartItem> cart)
        {
            ...
            foreach (var cartItem in cart)
            {
                ...
                //Start N&N Changes
                orderItem.PriceExclTax = _taxService.GetProductPrice(cartItem.Product, itemSubtotal, false, _workContext.CurrentCustomer, out _, out _, false, decimal.Zero);
                //End N&N Changes
