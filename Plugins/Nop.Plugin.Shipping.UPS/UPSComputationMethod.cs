...
using PickupType = Nop.Plugin.Shipping.UPS.Domain.PickupType;
...
namespace Nop.Plugin.Shipping.UPS
{
    ...
    public class UPSComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        public List<Package> GetShippingPackingOptions(GetShippingOptionRequest getShippingOptionRequest)
        {
         ...
         return _upsService.GetShippingPackingOptions(getShippingOptionRequest);
        }
        ...
        public GetShippingOptionResponse GetShippingOptions(GetShippingOptionRequest getShippingOptionRequest)
        {
            ...
            //if (getShippingOptionRequest.Packed)
                return _upsService.GetRates(getShippingOptionRequest);
            //else
            //    return _upsService.GetPackingForUPS(getShippingOptionRequest);
        }
		...
		public GetShippingOptionRequest GetBoxesPackingData(GetShippingOptionRequest shippingOptionRequest)
        {
            ...
            return _upsService.GetBoxesPackingData(shippingOptionRequest);
        }
