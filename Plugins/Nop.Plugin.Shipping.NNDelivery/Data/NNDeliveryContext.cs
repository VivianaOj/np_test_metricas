...
{
    public class NNDeliveryContext : DbContext, IDbContext
    {
        #region Ctor

        public NNDeliveryContext(DbContextOptions<NNDeliveryContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new DeliveryRoutesMap());
        ...
        {
            //drop the table
            this.DropPluginTable("DeliveryRoutes");
        }
