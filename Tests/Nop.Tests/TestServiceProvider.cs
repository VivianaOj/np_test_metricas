    ...
    public class TestServiceProvider : IServiceProvider
    {
        public TestServiceProvider()
        {
            ...
            PriceCalculationService = new PriceCalculationService(new CatalogSettings(), new CurrencySettings(), 
                ...
                new Mock<IProductService>().Object, new TestCacheManager(), new Mock<IStoreContext>().Object, WorkContext.Object, new ShoppingCartSettings(), new Mock<IPriceLevelService>().Object);
