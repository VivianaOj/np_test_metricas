...
namespace Nop.Services.Tests.Tax
{
    ...
    public class TaxServiceTests : ServiceTest
    {
        ...
        public void Can_get_productPrice_priceIncludesTax_includingTax_taxable()
        {
            ...
            var product = new Product();
            //Start N&N Changes
            _taxService.GetProductPrice(product, 0, 1000M, true, customer, true, out _, false, out _, false, decimal.Zero).ShouldEqual(1000);
            _taxService.GetProductPrice(product, 0, 1000M, true, customer, false, out _, false, out _, false, decimal.Zero).ShouldEqual(1100);
            _taxService.GetProductPrice(product, 0, 1000M, false, customer, true, out _, false, out _, false, decimal.Zero).ShouldEqual(909.0909090909090909090909091M);
            _taxService.GetProductPrice(product, 0, 1000M, false, customer, false, out _, false, out _, false, decimal.Zero).ShouldEqual(1000);
            //End N&N Changes
        }
        ...
        public void Can_get_productPrice_priceIncludesTax_includingTax_non_taxable()
        {
            ...
            //Start N&N Changes
            _taxService.GetProductPrice(product, 0, 1000M, true, customer, true, out _, false,out _, false, decimal.Zero).ShouldEqual(909.0909090909090909090909091M);
            _taxService.GetProductPrice(product, 0, 1000M, true, customer, false, out _, false, out _, false, decimal.Zero).ShouldEqual(1000);
            _taxService.GetProductPrice(product, 0, 1000M, false, customer, true, out _, false, out _, false, decimal.Zero).ShouldEqual(909.0909090909090909090909091M);
            _taxService.GetProductPrice(product, 0, 1000M, false, customer, false, out _, false, out _, false, decimal.Zero).ShouldEqual(1000);
            //End N&N Changes
        }
