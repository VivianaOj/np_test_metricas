...
namespace Nop.Services.Tests.Orders
{
    ...
    public class OrderTotalCalculationServiceTests : ServiceTest
    {
        ...
        private Mock<IPriceLevelService> _priceLevelMockService;
        private IBoxesGeneratorServices _boxesGeneratorServices;
        ...
        public new void SetUp()
        {
            ...
            _priceLevelMockService = new Mock<IPriceLevelService>();
            ...
            _priceCalculationService = new PriceCalculationService(_catalogSettings, _currencySettings, _categoryService.Object,
                ...
                _workContext.Object, _shoppingCartSettings, _priceLevelMockService.Object);
            ...
            _shippingService = new ShippingService(_addressService.Object,
                ...
                _shippingSettings,
                _shoppingCartSettings, _boxesGeneratorServices, null, null);
        ...
        public void Can_get_shopping_cart_subTotal_excluding_tax()
        {
            ...
            _orderTotalCalcService.GetShoppingCartSubTotal(cart, false,
                ...
                out var subTotalWithoutDiscount, out var subTotalWithDiscount, out var taxRates, out var amountCollect);
            //End N&N Changes
        ...
        public void Can_get_shopping_cart_subTotal_discount_including_tax()
        {
            ...
            _orderTotalCalcService.GetShoppingCartSubTotal(cart, true,
                ...
                out var taxRates, out var amountCollect);
            //End N&N Changes
